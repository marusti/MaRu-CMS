<style>
  ...
  .error-404-container .search-form input {
    padding: 10px;
    width: 250px;
  ...
  .error-404-container .search-form button {
    padding: 10px 15px;
    background: #3498db;
    color: white;
    border: none;
  ...
  .error-404-container .search-form button:hover {
    background: #2980b9;
  }
</style>
...
<div class="error-404-container">
  ...
  <form action="/suche" method="get" class="search-form">
    <input type="text" name="q" placeholder="Suchbegriff eingeben..." required>
